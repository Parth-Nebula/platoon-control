...
2. Installing the MPCPkg Package

A. Change to the directory that contains the file setup.py and the subdirectory MPCPkg. 
...
3. Using the MPCPkg Package

The MPCPkg package is on your Python path. To import it into a Python script or session, 
execute:
